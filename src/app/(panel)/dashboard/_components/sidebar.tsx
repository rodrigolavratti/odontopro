...
export function SidebarDashboard({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen w-full">
      <aside
        className={clsx(
          "flex flex-col border-r bg-background transistion-all duration-300 p-4 h-full",
          {
            "w-20": isCollapsed,
            "w-64": !isCollapsed,
      ...
      >
        <div className="mb-6 mt-4">
          {!isCollapsed && <Image src={logoImg} alt="Logo OdontoPRO" priority quality={75} />}
        </div>

        <Button
          className="bg-gray-100 hover:bg-gray-50 text-zinc-900 self-end px-4"
        ...
        {/* Mostrar apenas os icones quando o sidebar está recolhido */}
        {isCollapsed && (
      ...
      >
        <header className="md:hidden flex items-center justify-between border-b px-4 md:px-6 h-14 z-10 sticky top-0 bg-white">
          <Sheet>
            ...
            <SheetContent side="right" className="sm:max-w-xl text-black">
              <SheetHeader>
